// smallgine racing demo. Config-driven: "sandbox": false for a clean circuit,
// "raceMode": true for the arcade car controller + chase camera + lap timing.
...
int main(int /*argc*/, char* /*argv*/[])
{
    ...
    engine.setGameMode(std::make_unique<RaceMode>());
    win.run();
    return 0;
}
